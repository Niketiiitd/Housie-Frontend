...
declare global {
  interface Window {
    api: {
      getLicense: () => Promise<{ valid: boolean; error: any; data: any }>,
      loadLicenseFile: () => Promise<{ ok: boolean; data: any; error: any }>
    };
  }
}

function LicenseChecker({ children }: { children: ReactNode }) {
